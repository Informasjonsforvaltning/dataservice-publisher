"""Repository module for absracting the data storage."""
from typing import Any, List

from dataservice_publisher.mapper.mappers import Catalog, DataService
...
def fetch_catalog_by_id(id: int) -> Any:
...
def fetch_dataservice_by_id(id: int) -> Any:
